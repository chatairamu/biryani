    ...
    if (!empty($code) && !empty($type) && is_numeric($value)) {
        try {
            ...
            if ($e->errorInfo[1] == 1062) {
                ...
                $errors[] = "Database error: Could not add coupon.";
            }
        }
    } else {
        $errors[] = "Coupon code, type, and value are required. Value must be a number.";
    }
}
...
<p>Create and manage promotional coupon codes for your store.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($coupon['type'] === 'percentage'): ?>
                                        <?php echo htmlspecialchars($coupon['value']); ?>%
                                    <?php else: ?>
